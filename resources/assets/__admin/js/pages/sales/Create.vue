...
export default {
  ...
  methods: {
    levels() {
      this.$http
        .get('/admin/v1/json/sales-levels/list')
        .then(res => {
    ...
    getAgent() {
      ...
      this.$http
        .get(`/admin/v1/json/sales/${this.$route.params.id}/edit`)
        .then(res => {
    ...
    update() {
      ...
      this.$http
        .put(`/admin/v1/json/sales/${this.$route.params.id}`, {
          level: this.input.level
        })
        .then(res => {
          this.$notify({

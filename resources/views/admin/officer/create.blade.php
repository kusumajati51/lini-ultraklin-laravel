    ...
    <div class="uk-card-header uk-padding-remove">
        <div class="uk--tool-header uk-grid-collapse" uk-grid>
            ...
            <div class="uk-width-expand">
                <h3 class="uk--tool-header-title">NEW OFFICER</h3>
            </div>
        </div>
    </div>
    <div class="uk-card-body">
        <form action="{{ url('/admin/officers') }}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="uk-margin">
                ...
                <div class="el-input">
                    <input class="el-input__inner" type="text" name="phone" value="{{ old('phone') }}">
                </div>
            ...
            <div class="uk-margin">
                ...
                <div class="el-input">
                    <input class="el-input__inner" type="email" name="email" value="{{ old('email') }}">
                </div>
...
<script>
    new Vue({
        ...
        data: {
            input: {
                region: JSON.parse('{!! json_encode(old("region", [])) !!}'),
                gender: '{{ old("gender") }}',
                role: {!! old('role', "''") == '' ? "''" : old('role', "''") !!},
            },
